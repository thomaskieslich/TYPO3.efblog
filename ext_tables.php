...
$TCA['tt_content']['types']['list']['subtypes_excludelist']['tkblog_pi1'] = 'layout,select_key,recursive';
$TCA['tt_content']['types']['list']['subtypes_addlist']['tkblog_pi1'] = 'pi_flexform';
t3lib_extMgm::addPiFlexFormValue('tkblog_pi1', 'FILE:EXT:' . $_EXTKEY . '/Configuration/FlexForms/flexform.xml');


t3lib_extMgm::addStaticFile($_EXTKEY,'Configuration/TypoScript','TK Blog');
